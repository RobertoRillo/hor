...
export default function ArtistsPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-gray-300 font-mono relative overflow-hidden bg-fixed bg-center bg-no-repeat bg-cover bg-[url('/espada-optimized.png')]">
      {/* Ruido de fondo */}
